...
struct StubShowsRepository: ShowsRepository {
   var fetchShowsHandler: @Sendable (Int) async throws -> Envelope<Page<SingleShowModel>>
   var searchShowHandler: @Sendable (String) async throws -> Envelope<QueriedShowsModel>
   var fetchEpisodesHandler: @Sendable (Int) async throws -> Envelope<EpisodesListModel>
